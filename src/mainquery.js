...
module.exports = {
  getAllRoomList () {
    return knex('user')
      ...
      .select('chat_room.city_id', 'chat_room.id', 'user.id as initUserId', 'city.id as initCityId', 'chat_room.name', 'chat_room.description', 'chat_room.start_at', 'chat_room.photo', 'user.nickname', 'user.profile_photo', 'user.like', 'city.city_name', 'city.city_photo')
  },
